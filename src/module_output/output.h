...
public:
    ...
    std::ofstream outputSoilResourcesPerSoilLayer; /// Output file stream for writing data.
    ...
    std::stringstream bufferSoilResourcesPerSoilLayer; /// Temporary storage buffer for output data of soil resources per soil layer.
